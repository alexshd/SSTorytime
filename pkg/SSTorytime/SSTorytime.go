...
const (
	...
	EXPR_INTENT_L     = "has contextual theme" // UNUSED: const EXPR_INTENT_L (0 refs)
	EXPR_INTENT_S     = "has_theme" // UNUSED: const EXPR_INTENT_S (0 refs)
	INV_EXPR_INTENT_L = "is a context theme in" // UNUSED: const INV_EXPR_INTENT_L (0 refs)
	INV_EXPR_INTENT_S = "theme_of" // UNUSED: const INV_EXPR_INTENT_S (0 refs)

	EXPR_AMBIENT_L     = "has contextual highlight" // UNUSED: const EXPR_AMBIENT_L (0 refs)
	EXPR_AMBIENT_S     = "has_highlight" // UNUSED: const EXPR_AMBIENT_S (0 refs)
	INV_EXPR_AMBIENT_L = "is contextual highlight of" // UNUSED: const INV_EXPR_AMBIENT_L (0 refs)
	INV_EXPR_AMBIENT_S = "highlight_of" // UNUSED: const INV_EXPR_AMBIENT_S (0 refs)

	CONT_FINDS_L        = "contains extract/quote" // UNUSED: const CONT_FINDS_L (0 refs)
	CONT_FINDS_S        = "has-extract" // UNUSED: const CONT_FINDS_S (0 refs)
	INV_CONT_FOUND_IN_L = "extract/quote from" // UNUSED: const INV_CONT_FOUND_IN_L (0 refs)
	INV_CONT_FOUND_IN_S = "extract-fr" // UNUSED: const INV_CONT_FOUND_IN_S (0 refs)

	// This is a "contained-by something that expresses" shortcut => NEAR

	NEAR_FRAG_L        = "appears close to" // intentional characteristic // UNUSED: const NEAR_FRAG_L (0 refs)
	NEAR_FRAG_S        = "intend-expr" // UNUSED: const NEAR_FRAG_S (0 refs)
	INV_NEAR_FRAG_IN_L = "appears near" // explains intentional context // UNUSED: const INV_NEAR_FRAG_IN_L (0 refs)
	INV_NEAR_FRAG_IN_S = "intent-nr" // UNUSED: const INV_NEAR_FRAG_IN_S (0 refs)
)
...
var (
	...
	IGNORE_ARROWS []ArrowPtr // UNUSED: var IGNORE_ARROWS (0 refs)
...
// UNUSED: This function is not called anywhere in the codebase
func GetNodeContext(ctx PoSST, node Node) []string { // UNUSED: func GetNodeContext (0 refs)
...
func GetNodeTxtFromPtr(frptr NodePtr) string { // UNUSED: func GetNodeTxtFromPtr (0 refs)
	class := frptr.Class
	index := frptr.CPtr
...
func AppendLinkToNode(frptr NodePtr, link Link, toptr NodePtr) { // UNUSED: func AppendLinkToNode (0 refs)
	frclass := frptr.Class
	frm := frptr.CPtr
...
func PrintSTAIndex(stindex int) string { // UNUSED: func PrintSTAIndex (0 refs)
...
func InsertArrowDirectory(stname, alias, name, pm string) ArrowPtr { // UNUSED: func InsertArrowDirectory (0 refs)
...
func InsertInverseArrowDirectory(fwd, bwd ArrowPtr) { // UNUSED: func InsertInverseArrowDirectory (0 refs)
...
func GraphToDB(ctx PoSST, wait_counter bool) { // UNUSED: func GraphToDB (0 refs)
...
func Vertex(ctx PoSST, name, chap string) Node { // UNUSED: func Vertex (0 refs)
	var n Node
...
func Edge(ctx PoSST, from Node, arrow string, to Node, context []string, weight float32) (ArrowPtr, int) { // UNUSED: func Edge (0 refs)
...
func CreateDBNode(ctx PoSST, n Node) Node { // UNUSED: func CreateDBNode (0 refs)
	// Add node version setting explicit CPtr value, note different function call
	// We use this function when we ARE managing/counting CPtr values ourselves
...
func GetDBNodePtrMatchingName(ctx PoSST, name, chap string) []NodePtr { // UNUSED: func GetDBNodePtrMatchingName (0 refs)
...
func GetDBContextByPtr(ctx PoSST, ptr ContextPtr) (string, ContextPtr) { // UNUSED: func GetDBContextByPtr (0 refs)
...
func GetDBArrowBySTType(ctx PoSST, sttype int) []ArrowDirectory { // UNUSED: func GetDBArrowBySTType (0 refs)
...
func ArrowPtrFromArrowsNames(ctx PoSST, arrows []string) ([]ArrowPtr, []int) { // UNUSED: func ArrowPtrFromArrowsNames (0 refs)
...
func GetFwdConeAsNodes(ctx PoSST, start NodePtr, sttype, depth int, limit int) []NodePtr { // UNUSED: func GetFwdConeAsNodes (0 refs)
...
func GetFwdConeAsLinks(ctx PoSST, start NodePtr, sttype, depth int) []Link { // UNUSED: func GetFwdConeAsLinks (0 refs)
...
func GetEntireNCConePathsAsLinks(ctx PoSST, orientation string, start NodePtr, depth int, chapter string, context []string, limit int) ([][]Link, int) { // UNUSED: func GetEntireNCConePathsAsLinks (0 refs)
	// orientation should be "fwd" or "bwd" else "both"
...
const (
	R0 = 0.4 // radii should not overlap // UNUSED: const R0 (0 refs)
	R1 = 0.3
	R2 = 0.1
)
...
func AssignContextSetCoordinates(origin Coords, nth, swimlanes int) Coords { // UNUSED: func AssignContextSetCoordinates (0 refs)
	N := float64(swimlanes)
	n := float64(nth)
...
func AssignFragmentCoordinates(origin Coords, nth, swimlanes int) Coords { // UNUSED: func AssignFragmentCoordinates (0 refs)
...
func GetPathsAndSymmetries(ctx PoSST, start_set, end_set []NodePtr, chapter string, context []string, maxdepth int) [][]Link { // UNUSED: func GetPathsAndSymmetries (0 refs)
...
func GetPathTransverseSuperNodes(ctx PoSST, solutions [][]Link, maxdepth int) [][]NodePtr { // UNUSED: func GetPathTransverseSuperNodes (0 refs)
...
func SymbolMatrix(m [][]float32) [][]string { // UNUSED: func SymbolMatrix (0 refs)
	var symbol [][]string
	dim := len(m)
...
func SymbolicMultiply(m1, m2 [][]float32, s1, s2 [][]string) ([][]float32, [][]string) { // UNUSED: func SymbolicMultiply (0 refs)
...
// UNUSED: This function is not called anywhere in the codebase
func GetSparseOccupancy(m [][]float32, dim int) []int { // UNUSED: func GetSparseOccupancy (0 refs)
...
func SymmetrizeMatrix(m [][]float32) [][]float32 { // UNUSED: func SymmetrizeMatrix (0 refs)
...
// UNUSED: This function is not called anywhere in the codebase
func TransposeMatrix(m [][]float32) [][]float32 { // UNUSED: func TransposeMatrix (0 refs)
	var dim int = len(m)
...
func ComputeEVC(adj [][]float32) []float32 { // UNUSED: func ComputeEVC (0 refs)
...
func FindGradientFieldTop(sadj [][]float32, evc []float32) (map[int][]int, []int, [][]int) { // UNUSED: func FindGradientFieldTop (0 refs)
...
// UNUSED: This function is not called anywhere in the codebase
func NextLinkArrow(ctx PoSST, path []Link, arrows []ArrowPtr) string { // UNUSED: func NextLinkArrow (0 refs)
	var rstring string
...
func GetSequenceContainers(ctx PoSST, nodeptrs []NodePtr, arrowptrs []ArrowPtr, sttypes []int, limit int) []Story { // UNUSED: func GetSequenceContainers (0 refs)
	// Story search
...
func ContextIntentAnalysis(spectrum map[string]int, clusters []string) ([]string, []string) { // UNUSED: func ContextIntentAnalysis (0 refs)
...
func UpdateLastSawSection(ctx PoSST, name string) { // UNUSED: func UpdateLastSawSection (0 refs)
...
func UpdateLastSawNPtr(ctx PoSST, class, cptr int, name string) { // UNUSED: func UpdateLastSawNPtr (0 refs)
...
var (
	...
	STM_INV_GROUP = make(map[string]History) // look for invariants // UNUSED: var STM_INV_GROUP (0 refs)
)
...
func UpdateSTMContext(ctx PoSST, ambient, key string, now int64, params SearchParameters) string { // UNUSED: func UpdateSTMContext (0 refs)
	var context []string
...
// UNUSED: This function is not called anywhere in the codebase (marked as deleted)
func ContextInterferometry(now_ctx string) { // UNUSED: func ContextInterferometry (0 refs)
	// deleted
}

// *********************************************************************

func ShowContext(amb, intent, key string) { // UNUSED: func ShowContext (0 refs)
	fmt.Println()
	fmt.Println("  .......................................................")
...
func IntersectContextParts(context_clusters []string) (int, []string, [][]int) { // UNUSED: func IntersectContextParts (0 refs)
...
func GetContextTokenFrequencies(fraglist []string) map[string]int { // UNUSED: func GetContextTokenFrequencies (0 refs)
	spectrum := make(map[string]int)
...
func PrintNodeOrbit(ctx PoSST, nptr NodePtr, limit int) { // UNUSED: func PrintNodeOrbit (0 refs)
	node := GetDBNodeByNodePtr(ctx, nptr)
	fmt.Print("\"")
...
func PrintLinkPath(ctx PoSST, cone [][]Link, p int, prefix string, chapter string, context []string) { // UNUSED: func PrintLinkPath (0 refs)
...
func JSONNodeEvent(ctx PoSST, nptr NodePtr, xyz Coords, orbits [ST_TOP][]Orbit) NodeEvent { // UNUSED: func JSONNodeEvent (0 refs)
	node := GetDBNodeByNodePtr(ctx, nptr)
...
func LinkWebPaths(ctx PoSST, cone [][]Link, nth int, chapter string, context []string, swimlanes, limit int) [][]WebPath { // UNUSED: func LinkWebPaths (0 refs)
...
func JSONPage(ctx PoSST, maplines []PageMap) string { // UNUSED: func JSONPage (0 refs)
...
func GetAppointedNodesBySTType(ctx PoSST, sttype int, cn []string, chap string, size int) map[ArrowPtr][]Appointment { // UNUSED: func GetAppointedNodesBySTType (0 refs)
	// return a map of all the nodes in chap,context that are pointed to by the same type of arrow
	// grouped by arrow
...
func BetweenNessCentrality(ctx PoSST, solutions [][]Link) []string { // UNUSED: func BetweenNessCentrality (0 refs)
...
func DecodeSearchField(cmd string) SearchParameters { // UNUSED: func DecodeSearchField (0 refs)
	keywords := []string{
...
// UNUSED: This variable is not used anywhere in the codebase
...
const (
	CF_MONDAY_MORNING   = 345200 // UNUSED: const CF_MONDAY_MORNING (0 refs)
	CF_MEASURE_INTERVAL = 5 * 60 // UNUSED: const CF_MEASURE_INTERVAL (0 refs)
	CF_SHIFT_INTERVAL   = 6 * 3600 // UNUSED: const CF_SHIFT_INTERVAL (0 refs)
)

const (
	MINUTES_PER_HOUR   = 60 // UNUSED: const MINUTES_PER_HOUR (0 refs)
	SECONDS_PER_MINUTE = 60
	SECONDS_PER_HOUR   = (60 * SECONDS_PER_MINUTE)
	SECONDS_PER_DAY    = (24 * SECONDS_PER_HOUR)
	SECONDS_PER_WEEK   = (7 * SECONDS_PER_DAY) // UNUSED: const SECONDS_PER_WEEK (0 refs)
	SECONDS_PER_YEAR   = (365 * SECONDS_PER_DAY) // UNUSED: const SECONDS_PER_YEAR (0 refs)
	HOURS_PER_SHIFT    = 6
	SECONDS_PER_SHIFT  = (HOURS_PER_SHIFT * SECONDS_PER_HOUR) // UNUSED: const SECONDS_PER_SHIFT (0 refs)
	SHIFTS_PER_DAY     = 4 // UNUSED: const SHIFTS_PER_DAY (0 refs)
	SHIFTS_PER_WEEK    = (4 * 7) // UNUSED: const SHIFTS_PER_WEEK (0 refs)
)
...
func GetTimeContext() (string, string, int64) { // UNUSED: func GetTimeContext (0 refs)
	now := time.Now()
...
// UNUSED: This function is not called anywhere in the codebase
func GetUnixTimeKey(now int64) string { // UNUSED: func GetUnixTimeKey (0 refs)
	// Time on the torus (donut/doughnut) (CFEngine style)
...
const (
	DUNBAR_5   = 5 // UNUSED: const DUNBAR_5 (0 refs)
	DUNBAR_15  = 15
	DUNBAR_30  = 45
	DUNBAR_150 = 150
)
...
// UNUSED: This function is not called anywhere in the codebase
func NewNgramMap() [N_GRAM_MAX]map[string]float64 { // UNUSED: func NewNgramMap (0 refs)
...
func FractionateTextFile(name string) ([][][]string, int) { // UNUSED: func FractionateTextFile (0 refs)
	file := ReadFile(name)
...
// UNUSED: This function is not called anywhere in the codebase
func SplitCommandText(s string) []string { // UNUSED: func SplitCommandText (0 refs)
...
func AssessStaticTextAnomalies(L int, frequencies [N_GRAM_MAX]map[string]float64, locations [N_GRAM_MAX]map[string][]int) ([N_GRAM_MAX][]TextRank, [N_GRAM_MAX][]TextRank) { // UNUSED: func AssessStaticTextAnomalies (0 refs)
...
func AssessTextCoherentCoactivation(L int, ngram_loc [N_GRAM_MAX]map[string][]int) ([N_GRAM_MAX]map[string]int, [N_GRAM_MAX]map[string]int, int) { // UNUSED: func AssessTextCoherentCoactivation (0 refs)
...
func ExtractIntentionalTokens(L int, selected []TextRank, Nmin, Nmax int) ([][]string, [][]string, []string, []string) { // UNUSED: func ExtractIntentionalTokens (0 refs)
...
func RunningIntentionality(t int, frag string) float64 { // UNUSED: func RunningIntentionality (0 refs)
	// A round robin cyclic buffer for taking fragments and extracting
	// n-ngrams of 1,2,3,4,5,6 words separateed by whitespace, passing
...
// UNUSED: This function is not called anywhere in the codebase
func Array2Str(arr []string) string { // UNUSED: func Array2Str (0 refs)
	var s string
...
// UNUSED: This function is not called anywhere in the codebase
func Str2Array(s string) ([]string, int) { // UNUSED: func Str2Array (0 refs)
	var non_zero int
	s = strings.Replace(s, "{", "", -1)
	s = strings.Replace(s, "}", "", -1)
	s = strings.Replace(s, "\"", "", -1)
...
func SearchTermLen(names []string) int { // UNUSED: func SearchTermLen (0 refs)
	var maxlen int
...
func EscapeString(s string) string { // UNUSED: func EscapeString (0 refs)
	run := []rune(s)
	var res []rune
...
// UNUSED: This function is not called anywhere in the codebase
func ContextString(context []string) string { // UNUSED: func ContextString (0 refs)
	var s string
...
// UNUSED: This function is not called anywhere in the codebase
func Already(s string, cone map[int][]string) bool { // UNUSED: func Already (0 refs)
	for l := range cone {
